...
(function ($) {
  $(window).on("elementor/frontend/init", function () {
    ...
    const EAEPieChart = function($scope){

      const Chart_Wrapper = $scope.find(".eae-pie-chart-container");
      // console.log('test');
      // console.log(Chart_Wrapper)
      // const cid = $scope.data("id");
      const pie_chart = $scope.find("#eae-pie-chart");
      ...
      // const Chart_Outer_Wrapper = $scope.find(".eae-chart-outer-container");
      // console.log(Chart_Outer_Wrapper)
      // const cid = $scope.data("id");
      // console.log(cid)
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/wts-pie-chart.default",
      EAEPieChart
    );
  });
})(jQuery);
